...
const features = [
  ...
  },
  {
    ...
    features: [
      [
        "See stats for no. of visits",
        <i className="ml-2 far fa-chart-bar"></i>,
      ],
        ...
        <div className="container">
          <div className="row align-items-center justify-content-centers">
            <div className="col-md-6 text-centers">
              <h1>
                Keep it <span>brief!</span> An easier way to share & track
                links.
              </h1>
              <p>
                URL Shortener is a tool to help you create simple and
                easy-to-remember custom links for important links and also
                measure impact.
              </p>
                  ...
                  {!isLoading && shortenedUrl && (
                    <div className="result-pane">
                      <div className="link d-flex flex-wrap justify-content-between align-items-center">
                        <Link
                          to={`http://localhost:5002/${shortenedUrl}`}
                          rel="noreferrer"
                          target="_blank"
                        >
                        ...
                        <button
                          onClick={() =>
                            handleCopy(`url-bit.web.app/a/${shortenedUrl}`)
                          }
                        >
                      ...
                      <div className="detail">
                        <span>
                          <Link to="/register">Create Account</Link> for custom
                          back-half links, to manage links, qr codes & track
                          engagements.
                        </span>
                      </div>
                    </div>
        ...
        <div className="container">
          <div className="row align-items-center justify-content-center">
            <div className="col-md-8 text-center">
              ...
              <p>
                All the tools you need to manage links and QR Codes and connect
                with audiences everywhere, in a single unified platform.
              </p>
            </div>
            <div className="col-md-12">
              <div className="row justify-content-centers">
                {features.map(
                  ({ title, desciption, features: _features }, i) => {
                    return (
